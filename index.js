...
// Routing modules
var manageRoutes = require('./routes/manage-route.js');
var viewRoutes = require('./routes/view-route.js');
...
app.post('/select/identity', (req, res, next) => {
	rest.setDefaultIdentity(req.body['identity-wallet'], req.body['identity-id'], (setDefaultRes, setDefaultErr) => {
		...
		rest.getAllIdentities((getIDsRes, getIDsErr) => {
			...
			req.session.defaultIdentity.participant = util.getEntityNameFromFullyQualifiedName(systemID.participant);
